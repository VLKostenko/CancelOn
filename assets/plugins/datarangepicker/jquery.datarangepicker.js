...
(function(factory) {
  ...
  $.fn.dateRangePicker = function(opt) {
    ...
    var outputDom = $('.datepicker-output');
    var domChangeTimer;
    ...
    function showSelectedInfo(forceValid, silent) {
      ...
      if (opt.start && opt.singleDate) {
        ...
        if ( opt.extraClass === 'change-date-datepicker' ) {
          dateRangeStartDay = moment(new Date(opt.start)).format('DD');
          dateRangeStartDayName = moment(new Date(opt.start)).format('dddd');
          dateRangeEndDay = moment(new Date(opt.end)).format('DD');
          dateRangeEndDayName = moment(new Date(opt.end)).format('dddd');
          dateRangeStartMonth = moment(new Date(opt.start)).format('MMMM');
          dateRangeEndMonth = moment(new Date(opt.end)).format('MMMM');
          dateRangeStartYear = moment(new Date(opt.start)).format('YYYY');
          dateRangeEndYear = moment(new Date(opt.end)).format('YYYY');
          var totalDayStart = moment(new Date(opt.start));
          var totalDayEnd = moment(new Date(opt.end));
          totalDays = totalDayEnd.diff(totalDayStart, 'day') + 1;
          // countDays(start, end);
          // countDays(totalDayStart, totalDayEnd); TODO use it if other code doesn't work

          opt.setValue.call(selfDom.innerHTML = " <span class='day'>" + dateRangeStartDay + "</span>");
          opt.setValue.call(selfDom.innerHTML += " <span class='month'>" + dateRangeStartMonth + "</span>");
          opt.setValue.call(selfDom.innerHTML += " <span class='year'>" + dateRangeStartYear + "</span>");
          opt.setValue.call(selfDom.innerHTML += " <span class='dayName hidden'>" + dateRangeStartDayName + "</span>");
          opt.setValue.call(outputDom.get(0).innerHTML = " <span class='day'>" + dateRangeEndDay + "</span>");
          opt.setValue.call(outputDom.get(0).innerHTML += " <span class='month'>" + dateRangeEndMonth + "</span>");
          opt.setValue.call(outputDom.get(0).innerHTML += " <span class='year'>" + dateRangeEndYear + "</span>");
          opt.setValue.call(outputDom.get(0).innerHTML += " <span class='dayName hidden'>" + dateRangeEndDayName + "</span>");
          opt.setValue.call($('.datepicker-total').get(0).innerHTML = " <span class='nights'>" + totalDays + "</span>");
        } else {
