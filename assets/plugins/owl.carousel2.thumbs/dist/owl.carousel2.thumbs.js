...
(function ($, window, document, undefined) {
    ...
    Thumbs.prototype.setActive = function () {
        ...
        thumbContainer.find('.' + options.thumbItemClass).filter('.active').removeClass('active');
        thumbContainer.find('.' + options.thumbItemClass).eq(this.owl_currentitem).addClass('active');
    };
